...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # and [2, 3, 4].inject(2) { |product, item| product * item }
    # would return 2*2*3*4
  ...
  def test_all_iteration_methods_work_on_any_collection_not_just_arrays
    ...
    # expected it was going to be (11..13)
  ...
  # For me the indentation gives a sense that only this block will work on the file
  # so the second example would look more confusing at a first glance
  #
