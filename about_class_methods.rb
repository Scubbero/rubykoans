...
class AboutClassMethods < Neo::Koan
  ...
  # 
  # From a readability perspective the 2nd one seems better,
  # since you group all the class methods in a single place
  # this opinion might change once i start using it
