...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # i cheated and searched for it https://stackoverflow.com/a/55740573
    # it seems that send can be overwritten without warning while __send__ shows a warning
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # It would handle methods that are not defined
    #
    # NOTE:
    #
