...
class AboutSymbols < Neo::Koan
  ...
  # A: Ohhhh! because comparing to a symbol would create the symbol thus existing?
  ...
  def test_symbols_with_spaces_can_be_built
    symbol = :"cats and dogs" # i was wondering about this, altough i'm not sure how useful it is
  ...
  def test_symbols_do_not_have_string_methods
    symbol = :not_a_string
    assert_equal false, symbol.respond_to?(:each_char) # useful for duck typing
